...
- (CGRect)textRectForBounds:(CGRect)bounds {
    if (showingError) {
        ...
        return CGRectMake(35, 4, bounds.size.width, bounds.size.height);
    }
}
...
-(void)initialization{
    ...
    if (_placeHolderColor == nil){
        _placeHolderColor = [UIColor colorWithRed:0.00 green:0.18 blue:0.35 alpha:1.0];
    }
    
    //2. Placeholder Color When Selected.
    if (_selectedPlaceHolderColor==nil) {
        _selectedPlaceHolderColor = [UIColor colorWithRed:0.00 green:0.18 blue:0.35 alpha:1.0];
    }
...
-(void)addPlaceholderLabel{
    ...
    _labelPlaceholder = [[UILabel alloc]initWithFrame:CGRectMake(35, 0, self.frame.size.width-35, CGRectGetHeight(self.frame))];
...
-(void)addErrorPlaceholderLabel{
    ...
    _labelErrorPlaceholder = [[UILabel alloc] initWithFrame:CGRectMake(35, 0, self.frame.size.width-35, CGRectGetHeight(self.frame))];
...
//        }];
    ...
    CGRect frame = CGRectMake(35, 5, self.frame.size.width-35, self.frame.size.height-10);
//    CGRect bottmLineFrame = bottomLineView.frame;
//    bottmLineFrame.origin.y = CGRectGetHeight(self.frame)-1;
    [UIView animateWithDuration:0.2 animations:^{
        _labelPlaceholder.frame = frame;
